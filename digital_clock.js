...
setInterval(()=>{
    ...
    if(hours >= 12){ //This block of codes states what happens when it's past 12pm or 12am
        day_night = "PM"  //Adds "pm" to everytime above 11am
        hours = hours - 12; //E.g. 13pm = 1pm
    }
    if(hours == 0){  //This is to return 12 when hours - 12 = 0 
        hours = 12;
    }
